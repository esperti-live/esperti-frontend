        ...
        if (i + 1 <= rating) {
          ...
          return (
            ...
            >
              <title>star</title>
              <g fill="#0b47a6">
                <path d="M58.09 18.86l-16.07-2.34-7.18-14.56c-1.29-2.6-5.02-2.63-6.32 0l-7.18 14.56-16.07 2.34c-2.88 0.42-4.04 3.97-1.95 6.01l11.63 11.33-2.75 16.01c-0.49 2.89 2.55 5.06 5.1 3.7l14.38-7.55 14.38 7.55c2.55 1.34 5.6-0.81 5.1-3.7l-2.75-16.01 11.63-11.33c2.09-2.04 0.94-5.59-1.95-6z m-15.34 15.49l2.6 15.23-13.67-7.19-13.67 7.19 2.6-15.23-11.06-10.78 15.29-2.22 6.84-13.86 6.84 13.86 15.29 2.22-11.06 10.78z"></path>
              </g>
            </svg>
          );
        }
